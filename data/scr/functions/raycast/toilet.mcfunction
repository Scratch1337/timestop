...
execute align xyz positioned ~0.5 ~.5 ~0.5 align xyz positioned ~0.5 ~.5 ~0.5 run timedt 20 'setblock ~ ~ ~ air destroy'
execute align xyz positioned ~0.5 ~.5 ~0.5 align xyz positioned ~0.5 ~.5 ~0.5 run timedt 20 'kill @e[type=item,nbt={Item:{id:"pfm:basic_toilet"}}]'
